...
def main():
    ...
    analysis_type = st.sidebar.selectbox("Select Analysis Type", ["Loan Approval Analysis", "Borrower Characteristics Analysis", "Model Prediction"])
    ...
    if analysis_type == "Loan Approval Analysis":
        ...
        loan_csv_filename = "/Users/colinepiera/GitHub/CreditRisk/application_train.csv"
        ...
        data = pd.read_csv("/Users/colinepiera/GitHub/CreditRisk/application_train.csv")
    ...
    elif analysis_type == "Model Prediction":
        st.header("Model Prediction")

        # Load the model
        with open('python3model.pk', 'rb') as f:
        ...
        if uploaded_file is not None:
            ...
            loan_ids = data['SK_ID_CURR']

            # Make prediction
            prediction = loaded_model.predict(data)

            # Show prediction results
            final_predictions = pd.DataFrame(list(zip(loan_ids, prediction)), columns=['Loan ID', 'Prediction'])
